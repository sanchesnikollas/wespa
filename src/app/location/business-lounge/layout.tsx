...
export const metadata: Metadata = {
  title: 'Business & Lounge — Radnička 50',
  description:
    'WESPA Business & Lounge on Radnička cesta 50 in Zagreb. Premium coworking, private offices, meeting rooms, and a 300m² lounge with restaurant and cocktail bar.',
  keywords: [
