...
const content = {
  en: {
    ...
    workspaceTypes: [
      ...
      { title: 'Virtual Office', description: 'Premium Zagreb business address with mail handling and on-demand meeting rooms.', href: '/workspaces/virtual-office', price: 'From €49/month' },
    ],
  ...
  hr: {
    ...
    workspaceTypes: [
      ...
      { title: 'Virtualna adresa', description: 'Premium zagrebačka poslovna adresa s primanjem pošte i sobama za sastanke po potrebi.', href: '/workspaces/virtual-office', price: 'Od €49/mjesec' },
    ],
