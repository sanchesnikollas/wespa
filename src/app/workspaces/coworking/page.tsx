...
const content = {
  en: {
    ...
    plans: [
      ...
      { name: 'OwnDesk', price: '€219.00', period: '', image: '/images/workspaces/coworking/coworking-7.jpg', description: 'Your permanent workstation in the coworking zone. A dedicated home base with internet access and fair-use printing/scanning included.', features: ['Personal dedicated desk', 'Lockable storage', '24/7 access', 'Meeting room credits', 'Mail handling', 'High-speed WiFi'] },
        ...
        <section className="section-spacing" aria-labelledby="coworking-plans-heading">
          <div className="container-wespa">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              {c.plans.map((plan) => (
                <div key={plan.name} className="relative bg-white border border-stone-200 rounded-2xl overflow-hidden flex flex-col">
