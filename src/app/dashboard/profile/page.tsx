    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-8 py-12 text-center">
          ...
          <p className="text-gray-400 capitalize">{user?.membershipType} Member</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            <div className="flex items-center gap-3">
              <Icon name="lock" size="md" className="text-gray-400" />
              <div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            <div className="flex items-center gap-3">
              <Icon name="mail" size="md" className="text-gray-400" />
              <div>
