...
const content = {
  ...
  hr: {
    ...
    introTitle: 'Fleksibilan prostor koji radi za vas.',
    ...
    <>
      <main>
        <section className="relative text-white py-24 md:py-32 overflow-hidden">
          <Image src="/images/events/business/business-event-1.jpg" alt="WESPA business event" fill sizes="100vw" className="object-cover" priority />
        ...
        <section className="section-spacing">
          <div className="container-wespa">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6 max-w-4xl">{c.introTitle}</h2>
