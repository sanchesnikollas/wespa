...
const content = {
  en: {
    ...
    introBody: 'Step into the space that has become the heart of Zagreb’s startup culture. Whether you need a spot in our coworking hub or the privacy of your own office, everything is tailored to your pace, supporting your professional growth all the way.',
    featuresTitle: 'What Zavrtnica Offers',
    features: [
    ...
    addressStreet: 'Heinzelova ulica 60, 10000 Zagreb, Croatia',
  ...
  hr: {
    ...
    introBody: 'Uđite u prostor koji je postao srce zagrebačke startup kulture. Bilo da trebate mjesto u našem coworking hubu ili privatnost vlastitog ureda, sve je prilagođeno vašem ritmu i podržava vaš profesionalni rast na svakom koraku.',
    featuresTitle: 'Što Zavrtnica nudi',
    features: [
    ...
    <>
      <main>
        ...
        <section className="relative text-white py-24 md:py-32 overflow-hidden">
          <Image src="/images/locations/urban-hub/urban-hub-1.jpg" alt="WESPA Urban Hub" fill sizes="100vw" className="object-cover" priority />
