...
const content = {
  en: {
    ...
    membershipPerks: [
      { title: '24/7 Space Access', description: 'Your digital key is always with you. Use WESPA community zones whenever it suits you – day or night.' },
    ...
    ctaTitle: 'Become a Community Member',
  ...
  hr: {
    ...
    membershipPerks: [
      { title: '24/7 pristup prostoru', description: 'Vaš digitalni ključ uvijek je s vama. Koristite WESPA community zone kad god vam odgovara – danju ili noću.' },
    ...
    ctaTitle: 'Postanite član zajednice',
    ...
    <>
      <main>
        ...
        <section className="relative text-white py-24 md:py-32 overflow-hidden">
          <Image src="/images/events/spaces/venue-3.jpg" alt="WESPA community" fill sizes="100vw" className="object-cover" priority />
